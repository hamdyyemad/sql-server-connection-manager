...
export interface SecurityNotificationsRef {
  getValue: () => boolean;
}
...
const SecurityNotifications = forwardRef<SecurityNotificationsRef, SecurityNotificationsProps>(
...
SecurityNotifications.displayName = "SecurityNotifications";

export default memo(SecurityNotifications);
