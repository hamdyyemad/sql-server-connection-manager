...
export interface UpdateNotificationsRef {
  getValue: () => boolean;
}
...
const UpdateNotifications = forwardRef<UpdateNotificationsRef, UpdateNotificationsProps>(
...
UpdateNotifications.displayName = "UpdateNotifications";

export default memo(UpdateNotifications);
